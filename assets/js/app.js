...
(0, _jquery2.default)(document).ready(function () {
  ...
  var h1 = (0, _jquery2.default)('.typingtxt'),
      string = h1.data('text'),
      delay = (0, _jquery2.default)('.typingtxt').data('delay'),
      charText = string.length,
      i = 0;
  var interval = setInterval(function () {
    if (i <= charText) {
      i++;
      h1.html(string.substring(0, i));
    } else {
      clearInterval(interval);
    }
  }, delay);
});
/*typing text js ends here*/
/*one page navigation */
...
(0, _jquery2.default)('#contactme').validate();
